...
ui::UiSnapshot makeUiSnapshot() {
  ...
  state.batteryVisual = battery::makeBatteryVisualModel(battery);
  state.batteryRawSocAvailable = battery.rawSocAvailable;
  state.batteryRawSocPercent = battery.rawSocPercent;
  state.batteryCapacityRatioAvailable = battery.capacityRatioAvailable;
  state.batteryCapacityRatioPercent = battery.capacityRatioPercent;
  state.batteryFullEvidence = battery.fullEvidence;
  ...
  state.batteryRemainingCapacityStatus = battery.remainingCapacityStatus;
  state.batteryFullChargeCapacityStatus = battery.fullChargeCapacityStatus;
  state.batteryDesignCapacityStatus = battery.designCapacityStatus;
  ...
  state.batteryDesignCapacityMah = battery.designCapacityMah;
